...
⚠️ visualization_tree 当规则文本中有返佣层级/点位关系时，必须生成树形结构数据；没有层级关系才留 null。
{
  ...
  // ⚠️ visualization_tree：有返佣层级时必须填树形结构（至少2层：用户 + 1级以上）
  //    即使点位关系简单也要生成有意义的层级（如 用户→1-2个直接推荐），并给每个节点添加 description 说明
  "visualization_tree": [
    { "name": "你", "description": "你的位置", "children": [
      { "name": "A1", "description": "直接推荐1", "children": [
        { "name": "B1", "description": "共识账户1" },
        { "name": "B2", "description": "共识账户2" },
        { "name": "B3", "description": "共识账户3" },
        { "name": "B4", "description": "共识账户4" },
        { "name": "B5", "description": "共识账户5" }
      ]},
      { "name": "A2", "description": "直接推荐2", "children": [
        { "name": "B6", "description": "共识账户6" },
        { "name": "B7", "description": "共识账户7" },
        { "name": "B8", "description": "共识账户8" },
        { "name": "B9", "description": "共识账户9" },
        { "name": "B10", "description": "共识账户10" }
      ]},
      { "name": "A3", "description": "直接推荐3", "children": [
        { "name": "B11", "description": "共识账户11" },
        { "name": "B12", "description": "共识账户12" },
        { "name": "B13", "description": "共识账户13" },
        { "name": "B14", "description": "共识账户14" },
        { "name": "B15", "description": "共识账户15" }
      ]}
    ]}
  ],
