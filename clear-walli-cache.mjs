// 一次性脚本：清除 WALLI 0xc6A031fd... 的缓存
// 用法：node clear-walli-cache.mjs
...
const KEY = '0xc6A031fd206C72c614dB391590F48a5Ed9B2f9dC';
...
async function main() {
  ...
  console.log('清除后状态:', {
    ...
    last_searched_at_保留: after?.last_searched_at,
  });
  console.log('🎉 完成！下次再搜 WALLI 会重新走完整流程');
}
